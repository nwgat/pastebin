...
<?php endif; ?>
  <form action="paste.php" method="post" id="pasteform" class="form-inline">
    ...
    <i class="icon-lock icon-white" style="margin-top: 3px; margin-right: 3px;"></i><input type="checkbox" class="checkbox-inline showTooltip" title="Private Paste?" name="private" value="1">
