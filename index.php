...
<div id="pastearea" class="container-fluid">
  ...
  <form action="paste.php" method="post" id="pasteform" class="form-inline">
    ...
    <img class="icon-lock" style="padding-top: 4px; margin-top: 4px; color:#fff;"><input type="checkbox" class="checkbox-inline showTooltip" title="Private Paste?" name="private" value="1">
