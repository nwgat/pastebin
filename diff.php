...
function diffUsingJS () {
	var base = difflib.stringAsLines($("<?php echo htmlentities($altres['code']);?>").value);
	var newtxt = difflib.stringAsLines($("<?php echo htmlentities($result['code']);?>").value);
	...
	diffoutputdiv.appendChild(diffview.buildView({ baseTextLines:base,
												   newTextLines:newtxt,
												   opcodes:opcodes,
												   baseTextName:"<?php echo htmlentities($altres['sname']);?>",
												   newTextName:"<?php echo htmlentities($result['sname']);?>",
