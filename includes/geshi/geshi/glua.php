...
$language_data = array (
    ...
    'URLS' => array(
        2 => 'http://wiki.garrysmod.com/wiki/?title={FNAME}',
		3 => 'http://www.lua.org/manual/5.1/manual.html#pdf-{FNAME}',
		4 => 'http://wiki.garrysmod.com/wiki/?title=G.{FNAME}',
		5 => 'http://wiki.garrysmod.com/wiki/?title=Entity.{FNAME}',
		6 => 'http://wiki.garrysmod.com/wiki/?title=Player.{FNAME}',
		7 => 'http://wiki.garrysmod.com/wiki/?title={FNAME}',
        ),
    'OOLANG' => true,
